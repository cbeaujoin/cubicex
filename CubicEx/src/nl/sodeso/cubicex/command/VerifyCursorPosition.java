...
public class VerifyCursorPosition extends CubicExBaseTestCase {
	...
	private Log log = LogFactory.getLog(VerifyCursorPosition.class);
	...
	public void executeTest(final Map<String, String> arguments, final IElementContext context, final Selenium selenium) throws Exception {
		...
		if (log.isInfoEnabled()) {
			log.info("VerifyCursorPosition: target '" + _locator + "', value '" + _valueToCompareTo + "'.");
		}
		
		// Retrieve the field value.
		Number _valueOfField = selenium.getCursorPosition(_locator);
		verifyEquals(_valueOfField.intValue(), _valueToCompareTo.intValue());
	}
